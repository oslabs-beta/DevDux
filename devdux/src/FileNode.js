        ...
        (_b = this.astTokens) === null || _b === void 0 ? void 0 : _b.forEach(function (token, i, arr) {
            if (token.type.label === "jsxName") {
                if (_this.renderedComponents[0]) {
                    ...
                    else if (keyArray.includes(arr[i + 3].value) &&
                                                    ...
                                                    useSelectorArguments.forEach(function (argument) {
                                                        ...
                                                        if (argument.type === "ArrowFunctionExpression") {
                                                            if (argument.body.type === "MemberExpression") {
                                                                if (argument.body.object.type ===
                                                                    "MemberExpression") {
                                                                    if (argument.body.object.property.type ===
                                                                        "Identifier") {
                                                                        reducerName_1 =
                                                        ...
                                                        _this.selected.push((_a = {},
                                                            _a[variableLabel_1] = "".concat(reducerName_1, ".").concat(stateName_1),
                                                            _a));
                                                    });
                                                }
                                            }
                                ...
                                if (ArrowFuncBlock) {
                                    ...
                                    ArrowFuncBlock.forEach(function (blockElement) {
                                                                            ...
                                                                            if (element.init.body.body) {
                                                                                ...
                                                                                innerArrowFuncBlock.forEach(function (element) {
                                                                                    if (useDispatchLabel_1 !== undefined &&
                                                                                        ...
                                                                                        // );
                                                                                        if (element.expression.arguments[0]
                                                                                            .type === "CallExpression" &&
                                                                                            element.expression.arguments[0]
                                                                                                .callee.type === "Identifier") {
                                                                                            _this.dispatched.push(element.expression
                                        ...
                                        if (useDispatchLabel_1 !== undefined &&
                                            ...
                                            if (blockElement.expression.arguments[0].type ===
                                                "CallExpression" &&
